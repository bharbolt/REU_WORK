...
function domloaded(){
    ...
    qx.font="17px Arial";
    qx.fillText("Which of the following actions should the processor perform if the action following the above state is:",30,253);
	
	var q1=document.getElementById("myCanvas");
    var q1x=q1.getContext("2d");
    q1x.font="17px Arial";
    q1x.fillText("a) GETS   b) GETX   c) UPGRADE   d) no coherence action ",90,275);
}