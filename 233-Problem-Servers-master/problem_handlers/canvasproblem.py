...
class Canvasproblem(base_handler.BaseHandler):
  valid_types = [
    "canvasproblem"    # Description to Components
  ]
  ...
  def data_for_question(self,question_type):
	 A4 = 'A: '
   	 ...
   	 (pro, letter, action) = map(self.generator.choice, [[0,1,2],['A','B','C'],['loads','stores']])
	 answer = ''
	 if letter == 'A':
	 ...
	 description = 'Processor ' + str(pro+1) + ' ' + str(action) + ' ' + str(letter)
